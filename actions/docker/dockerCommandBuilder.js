...
const buildDockerCreate = function(config) {
    ...
    for (const param of wantedParams) {
...
const getMultipleOptionsFromArray = function(collectedData) {
    ...
    let result = "";
    for (const opt of collectedData.dv) {
